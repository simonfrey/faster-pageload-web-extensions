...
browser.storage.sync.get(["blacklistSites", "preloadViewport", "active"]).then(setPreloadViewport, onError);
function setPreloadViewport(result) {

	  if (result.active == false) {
		console.log("[faster pageload plugin] Inactive: Do not load instant.page script")
		return
	  }
	  if (result.preloadViewport == true) {
		document.body.dataset.instantIntensity = "viewport-all";
	  }
